...
/**
 * check_sub_tree_Left - it checks if all nodes are smaller than
 * the root specified
...
/**
 * check_sub_tree_Right -it checks if all the nodes are bigger than the
 * root specified
 * @node: node in the tree to verify condition
...
/**
 * binary_tree_is_bst -a function that checks if a binary
 * tree is a valid
